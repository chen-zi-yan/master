...
public class TreatyBookController {
    ...
    @PostMapping()
    public JsonBean<String> add(@RequestBody @Validated TreatyBookVO treatyBookVO) {
    ...
    @PutMapping()
    public JsonBean<String> update(@RequestBody @Validated TreatyBookVO treatyBookVO) {
