...
public interface WaterUseRecordsMapper extends BaseMapper<WaterUseRecords> {
     ...
     * @return 每月的累计用水量
     */
    List<MonthSumWaterByYearAndCodeVO> getMonthSumWater(String code, int year);
     ...
     */
    IPage<WaterUseRecordsVO> findListByPage(@Param("page") Page<WaterUseRecords> page, @Param("code") String code, @Param("farmerName") String farmerName, @Param("devSn") String devSn, @Param("type") String type);
     ...
     */
    List<MonthSumWaterByYearAndCodeVO> getMonthSumWaterByYearAndCode(@Param("year") Long year, @Param("code") String code);
}
